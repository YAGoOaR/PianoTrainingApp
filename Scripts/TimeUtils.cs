...
internal class TimeUtils
{
    ...
    public static double BPM2BeatTime(double beatsPerMinute) => 1 / beatsPerMinute * 60d;
    public static float BPM2BeatTime(float beatsPerMinute) => 1 / beatsPerMinute * 60f;
